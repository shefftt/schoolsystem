...
<div class="container mt-4" id="app">
    <div class="card">
        <div class="card-body">
			...
			<br>
            <form action="<?= base_url() ?>index.php/admin/sieral_post" method="post">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="">تاريخ بدايه الورس</label>
                        <input type="date" v-model="start_date" name="start_date" class="form-control" required="true">
                    </div>
                    <div class="form-group col-md-6">
					...
					<select name="trainer_id" class="form-control">
                        ...
                        <input type="hidden" name="course_id" value="<?= $course->course_id ?>" class="form-control" require>
                        <input type="hidden" name="number_of_days" value="<?= get_table_info("courses" , $course->course_id)->number_of_days ?>" class="form-control" require>
                    <div class="form-group col-md-12">
					<button class="btn btn-md btn-success" type="submit">اضافة</button>
        ...
        select_tacher() {
            if (this.start_date == "")
                ...
                toastr["error"]('اسم التاريخ اجبارى', "خطاء")
					...
					axios.get('<?= base_url() ?>index.php/api/get_techaers', {
                        params: {
