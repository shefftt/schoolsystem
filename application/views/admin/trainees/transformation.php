...
<div class="container mt-4" id="app">
    <div class="card">
        <div class="card-body">
			...
			<br>
            <form action="<?= base_url() ?>index.php/admin/transformation_post" method="post">
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="">تاريخ بدايه الورس</label>
                        <input type="date" v-model="class_date" value="<?= $classes->class_date ?>" name="class_date" class="form-control" required="true">
                    </div>
                    <div class="form-group col-md-6">
					...
					<select name="trainer_id" class="form-control">
                        ...
                        <input type="hidden" name="id" value="<?= $classes->id ?>" class="form-control" require>
                         <div class="form-group col-md-12">
					<button class="btn btn-md btn-success" type="submit">تحويل</button>
