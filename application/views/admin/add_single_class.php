            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    <div class="form-group">
                      ...
                      <select v-model="number_of_days" class="form-control" name="number_of_days">
    ...
    methods: {
        add_trainee() {
            if (this.name == "")
                ...
                axios.get('<?= base_url()?>index.php/api/add_single_class_post', {
                        params: {
        ...
        get_cat() {
            axios.get("<?= base_url() ?>index.php/api/get_all_single_class").then(response => (this
                .cats = response.data))
        },
    }
})
